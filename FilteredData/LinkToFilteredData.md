The GoodReadsDataClean.ipynb is a notebook for analyzing and filtering the data, but I included some filtered data below to use if you would like to skip that 
part. 
